...
function makeGrid(type, data) {
	...
	var holidays = {
		...
		"2019-05-02": {
			title: "Праздничный день (выходной за счёт 5-го января)",
			dayoff: true
		},
		"2019-05-03": {
		...
		"2019-05-10": {
			title: "Праздничный день (выходной за счёт 23-го февраля)",
			dayoff: true
		},
		"2019-06-01": {
			icon: "👶",
		...
		"2019-11-04": {
			icon: "✊",
			title: "День народного единства, праздничный день",
			dayoff: true
		},
		"2019-11-24": {
			icon: "👩",
